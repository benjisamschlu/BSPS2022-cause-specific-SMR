...
`r fontawesome::fa("arrow-right")` Cause-specific death counts and exposures by 5 year age group (1, 5, 10, ..., 95+), sex and municipality (589) aggregated over 2006-2016

### Covariates

* Belgian index of multiple deprivation (BIMD) 2011 (M. Otavova et al.)
...
* High SMR for low expected deaths $\propto$ pop. size `r fontawesome::fa("arrow-right")` sampling variability
...
```{r map_non_transport_m, out.width = "90%"}
...
# Ecological association with BIMD
...
* Death classification at old ages

# Next steps

* Incorporate environmental exposures
