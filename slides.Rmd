...
* Index of multiple deprivation and environmental stressors `r fontawesome::fa("arrow-right")` small-scale
...
```{r bimd_logo, out.width = '70%'}
# logo needs to be both in wd and where .Rmd is located
knitr::include_graphics("BIMD.PNG")
```

`r fontawesome::fa("arrow-right")` M. Otavova et al. (forthcoming)
...
* Poor classification of CoD at old ages
